...
fun main(): Unit = runBlocking {
    ...
    val registrationsPerSecond = benchmark.registrationCount / duration.inWholeSeconds
    if (registrationsPerSecond < 50) {
        System.err.println("ERROR: Benchmark failed. Processed $registrationsPerSecond registrations/sec, required 50.")
        System.exit(1)
    }
}
